...
def create_app() -> FastAPI:
    ...
    # Added BEFORE SessionMiddleware below, so it runs INSIDE the session layer.
    @app.middleware("http")
    ...
    # ---- Middlewares (added LAST run FIRST in Starlette) ----
    # Order: SessionMiddleware (outermost) -> TenantMiddleware -> auth_redirect_middleware -> route

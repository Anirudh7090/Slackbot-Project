...
Logic:
  - If exactly one active bot for the tenant -> use it.
  - If multiple bots -> match by the event's `api_app_id` (Slack tells us
    which app the event was delivered to).
  - As a last resort, fall back to the first active bot."""
